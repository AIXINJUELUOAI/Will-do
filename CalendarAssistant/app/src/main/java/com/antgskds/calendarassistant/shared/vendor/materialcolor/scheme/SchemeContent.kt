 ...
 */
package com.antgskds.calendarassistant.shared.vendor.materialcolor.scheme

import com.antgskds.calendarassistant.shared.vendor.materialcolor.dynamiccolor.ColorSpec.SpecVersion
import com.antgskds.calendarassistant.shared.vendor.materialcolor.dynamiccolor.ColorSpecs
import com.antgskds.calendarassistant.shared.vendor.materialcolor.dynamiccolor.DynamicScheme
import com.antgskds.calendarassistant.shared.vendor.materialcolor.dynamiccolor.Variant
...
class SchemeContent(
  ...
  DynamicScheme(
    ...
    ColorSpecs.get(specVersion)
      .getErrorPalette(Variant.CONTENT, sourceColorHctList.first(), isDark, platform, contrastLevel),
  ) {
  constructor(
    sourceColorHct: Hct,
    isDark: Boolean,
