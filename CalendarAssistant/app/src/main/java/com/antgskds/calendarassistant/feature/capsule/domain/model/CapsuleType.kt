package com.antgskds.calendarassistant.feature.capsule.domain.model

/**
 * 胶囊类型常量（厂商无关、纯数据）。
 *
 * 从 [com.antgskds.calendarassistant.feature.capsule.application.CapsuleStateManager] 抽出，
