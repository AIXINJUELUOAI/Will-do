package com.antgskds.calendarassistant.app.runtime.migration
...
class LegacyDataMigrationCoordinator(
    ...
    fun runAutoMigrationIfNeeded(force: Boolean = false): LegacyMigrationReport {
        ...
        val wasSyncEnabled = runCatching {
            val config = com.antgskds.calendarassistant.feature.schedule.domain.calendar.CalendarConfig.newInstance(appContext)
            config.caldavSync
        }.getOrDefault(false)
