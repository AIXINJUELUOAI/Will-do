...
class ClipboardCodeMonitorService : Service() {
    ...
    private fun createChannel() {
        ...
        val channel = NotificationChannel(
            CHANNEL_ID,
            SystemNormalDisplay.clipboardMonitorChannelName(),
            NotificationManager.IMPORTANCE_MIN
        ).apply {
            description = SystemNormalDisplay.clipboardMonitorChannelDescription()
            setShowBadge(false)
            setSound(null, null)
        }
    ...
    private fun buildNotification(): Notification {
        ...
        val content = SystemNormalDisplay.clipboardMonitorRunning()
