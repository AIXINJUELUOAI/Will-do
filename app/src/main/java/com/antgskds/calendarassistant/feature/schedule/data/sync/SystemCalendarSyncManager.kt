package com.antgskds.calendarassistant.feature.schedule.data.sync
...
import com.antgskds.calendarassistant.feature.schedule.domain.calendar.REMINDER_EMAIL
...
import com.antgskds.calendarassistant.feature.schedule.domain.calendar.SCHEDULE_CALDAV_REQUEST_CODE
import com.antgskds.calendarassistant.feature.schedule.domain.calendar.STATE_PENDING
import com.antgskds.calendarassistant.feature.schedule.domain.calendar.TAG_GENERAL
import com.antgskds.calendarassistant.feature.schedule.domain.model.CalDAVCalendar
...
class SystemCalendarSyncManager(private val context: Context) {
    ...
    private fun getCalDAVEventReminders(eventId: Long): List<com.antgskds.calendarassistant.feature.schedule.domain.model.Reminder> {
        val reminders = ArrayList<com.antgskds.calendarassistant.feature.schedule.domain.model.Reminder>()
        ...
        appContext.contentResolver.query(Reminders.CONTENT_URI, projection, selection, args, null)?.use { cursor ->
            ...
            while (cursor.moveToNext()) {
                ...
                if (method == Reminders.METHOD_ALERT || method == Reminders.METHOD_EMAIL) {
                    reminders.add(
                        com.antgskds.calendarassistant.feature.schedule.domain.model.Reminder(
    ...
    private fun getCalDAVEventAttendees(eventId: Long, calendar: CalDAVCalendar) =
        buildList {
            ...
            appContext.contentResolver.query(Attendees.CONTENT_URI, projection, selection, args, null)?.use { cursor ->
                ...
                while (cursor.moveToNext()) {
                    add(
                        com.antgskds.calendarassistant.feature.schedule.domain.model.Attendee(
                            contactId = 0,
